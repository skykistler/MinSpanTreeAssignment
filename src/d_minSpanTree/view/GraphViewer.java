...
public class GraphViewer implements ViewerInterface {
	...
	public void init() {
		...
		window.addEventHandler(MouseEvent.MOUSE_MOVED, new EventHandler<MouseEvent>() {
	...
	private void setupWindow() {
		...
		rand1e1n.setOnAction(e -> {
			controller.randNVertices(true, 10);
		});
		MenuItem rand1e2n = new MenuItem("Random 100");
		rand1e2n.setOnAction(e -> {
			controller.randNVertices(true, 100);
		});
		MenuItem rand1e3n = new MenuItem("Random 1000");
		rand1e3n.setOnAction(e -> {
			controller.randNVertices(true, 1000);
		});
		MenuItem rand1e4n = new MenuItem("Random 10000");
		rand1e4n.setOnAction(e -> {
			controller.randNVertices(true, 10000);
		});
		...
		rand1e1a.setOnAction(e -> {
			controller.randNVertices(false, 10);
		});
		MenuItem rand1e2a = new MenuItem("Random 100");
		rand1e2a.setOnAction(e -> {
			controller.randNVertices(false, 100);
		});
		MenuItem rand1e3a = new MenuItem("Random 1000");
		rand1e3a.setOnAction(e -> {
			controller.randNVertices(false, 1000);
		});
		MenuItem rand1e4a = new MenuItem("Random 10000");
		rand1e4a.setOnAction(e -> {
			controller.randNVertices(false, 10000);
		});
	...
	private void makeVertexDisplay(Vertex v) {
		...
		// text.relocate(circRadius - text.getBoundsInLocal().getWidth() / 2,
